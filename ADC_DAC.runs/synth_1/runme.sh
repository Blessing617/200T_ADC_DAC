...
HD_PWD='D:/Xilinx/Project/200t/ADC_DAC/ADC_DAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_DAC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_DAC.tcl
