...
HD_PWD='D:/Xilinx/Project/200t/ADC_DAC/ADC_DAC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_DAC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADC_DAC.tcl -notrace
